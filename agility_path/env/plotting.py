...
class Plotting:
    ...
    def _plot_obstacles(self):
        for obs in self.env.obstacles:
            ...
            plt.plot(obs.entrance1[0] + obs.position[0], obs.entrance1[1] + obs.position[1], "ro", markersize=3)
            plt.plot(obs.entrance2[0] + obs.position[0], obs.entrance2[1] + obs.position[1], "go", markersize=3)
